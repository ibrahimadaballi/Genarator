#github.com/ibrahimadaballi

#telegra.ph/Bilgi-11-19-3
#https://telegra.ph/Bilgi-11-19-3
...
class Main:
    def __init__(self):
        ...
        self.telegra.ph= "https://telegra.ph/Bilgi-11-19-3"
        self.option = 0
    ...
    def display_button_list(self):
        ...
        for i in range(7):
            ...
            i+=i
        text = text + f"[8] telegra.ph {Fore.GREEN}[ONLINE]{Fore.RESET}"
        print(text)
    ...
    def user_input_option(self):
        ...
        if self.option == 8:
            self.driver.get(self.telegra.ph)
        else:
